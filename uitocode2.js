                    ...
                    switch (cell.$.style.shape) {
                        case "mxgraph.mockup.buttons.button":
                            ...
                            const buttonCSS = buttons.map(button => {
                                ...
                                return `#${id} {border-width: ${style.strokeWidth}px; box-shadow: ${style.shadow}; ${dashed}; text-align: ${style.align}; background-color: 
                                ${style.fillColor}; color: ${style.fontColor}; font-size: ${style.fontSize}px; ${fontStyle}; border-color: ${style.strokeColor}; ${buttonStyle}; 
                                white-space: ${style.whiteSpace}; ${position}}`;
                            });
